...
public class Vault {
    ...
    private static final String AUTOMATICALLY_KEYED_PREF_FILE_NAME = "co.nyano.nyanomobile.automaticallyKeyedPref";
    private static final String AUTOMATICALLY_KEYED_KEY_FILE_NAME = "co.nyano.nyanomobile.automaticallyKeyedKey";
    private static final String AUTOMATICALLY_KEYED_KEY_ALIAS = "co.nyano.nyanomobile.automaticallyKeyed";
