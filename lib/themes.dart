...
class NyanoMobileTheme extends BaseTheme {
  static const brightPink = Color(0xFFF47AD7); //0xFFA3CDFF

  static const green = Color(0xFF4AFFAE);

  static const greenDark = Color(0xFF18A264);

  static const pinkishGreyDark = Color(0xFF361E3D);

  static const pinkishGreyLight = Color(0xFF894A7E);

  static const pinkishGreyDarkest = Color(0xFF371E3D);

  static const white = Color(0xFFFFFFFF);

  static const black = Color(0xFF000000);

  Color primary = brightPink;
  Color primary60 = brightPink.withOpacity(0.6);
  Color primary45 = brightPink.withOpacity(0.45);
  Color primary30 = brightPink.withOpacity(0.3);
  Color primary20 = brightPink.withOpacity(0.2);
  Color primary15 = brightPink.withOpacity(0.15);
  Color primary10 = brightPink.withOpacity(0.1);
  ...
  Color background = pinkishGreyDark;
  Color background40 = pinkishGreyDark.withOpacity(0.4);
  Color background00 = pinkishGreyDark.withOpacity(0.0);

  Color backgroundDark = pinkishGreyLight;
  Color backgroundDark00 = pinkishGreyDark.withOpacity(0.0);

  Color backgroundDarkest = pinkishGreyDarkest;
...
class NatriumTheme extends BaseTheme {
  static const brightBlue = Color(0xFF0E1032);
  ...
  Color barrier = white.withOpacity(0.7);
  Color barrierWeaker = white.withOpacity(0.4);
  Color barrierWeakest = white.withOpacity(0.3);
  Color barrierStronger = white.withOpacity(0.85);
