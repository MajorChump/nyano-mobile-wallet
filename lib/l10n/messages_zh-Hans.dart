...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("欢迎来到Nyano Mobile。当您收到或发送nyano时，交易将如下出现。"),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("注销将从此设备中删除您的种子和所有与Nyano Mobile相关的数据。如果您的种子代码没有备份，您将永远无法再次访问您的帐户"),
    ...
    "newAccountIntro" : MessageLookupByLibrary.simpleMessage("这是您的新账户。当您收到 nyano 时, 交易会如下出现："),
    ...
    "notificationBody" : MessageLookupByLibrary.simpleMessage("打开Nyano Mobile查看此交易"),
    ...
    "passwordNoLongerRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("您以后打开Nyano Mobile不再需要密码了。"),
    "passwordWillBeRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("以后需要这个密码才能打开Nyano Mobile。"),
    ...
    "requireAPasswordToOpenHeader" : MessageLookupByLibrary.simpleMessage("需要密码来打开Nyano Mobile吗？"),
    "rootWarning" : MessageLookupByLibrary.simpleMessage("您的设备似乎被“越狱”或被修改，从而存在安全隐患。建议您在继续之前把设备还原到初始状态。"),
    "scanInstructions" : MessageLookupByLibrary.simpleMessage("扫描nyano二维码地址"),
    ...
    "sendAmountConfirm" : MessageLookupByLibrary.simpleMessage("发送 %1 nyano"),
    ...
    "shareNyano" : MessageLookupByLibrary.simpleMessage("分享Nyano Mobile"),
    "shareNyanoText" : MessageLookupByLibrary.simpleMessage("来试试Nyano Mobile！ 一个卓越的nyano手机钱包！"),
    ...
    "transferComplete" : MessageLookupByLibrary.simpleMessage("%1 nyano 成功传送到您的 Nyano Mobile 钱包。\n"),
    "transferConfirmInfo" : MessageLookupByLibrary.simpleMessage("检测到一个包含 %1 nyano 的钱包。\n"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("这个过程会将纸钱包的钱币转移到您的 Nyano Mobile 钱包。\n\n请按 \"%1\" 键开始。"),
    "transferLoading" : MessageLookupByLibrary.simpleMessage("传送中"),
    "transferManualHint" : MessageLookupByLibrary.simpleMessage("请输入种子。"),
    "transferNoFunds" : MessageLookupByLibrary.simpleMessage("这个种子没有包含任何 nyano"),
    "transferQrScanError" : MessageLookupByLibrary.simpleMessage("这个二维码没有包含任何有效的种子。"),
    "transferQrScanHint" : MessageLookupByLibrary.simpleMessage("请扫描 nyano \n种子"),
    "unlock" : MessageLookupByLibrary.simpleMessage("解锁"),
    "unlockBiometrics" : MessageLookupByLibrary.simpleMessage("验证并解锁 Nyano Mobile"),
    "unlockPin" : MessageLookupByLibrary.simpleMessage("请输入识别码来解锁 Nyano Mobile"),
    ...
    "welcomeText" : MessageLookupByLibrary.simpleMessage("欢迎来到Nyano Mobile。下一步，您可以创建新钱包或导入已有钱包。"),
