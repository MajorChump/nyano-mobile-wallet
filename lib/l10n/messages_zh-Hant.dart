...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "exampleCardIntro" : MessageLookupByLibrary.simpleMessage("歡迎來到 Nyano Mobile。當您收到或發送 nyano 時，交易將顯示如下："),
    ...
    "logoutDetail" : MessageLookupByLibrary.simpleMessage("本動作會刪除您在本裝置裡頭的種子及所有和 Nyano Mobile 有關的資料。如果您的種子沒有備份，您將永遠無法存取您的帳戶"),
    ...
    "minimumSend" : MessageLookupByLibrary.simpleMessage("最低發送金額是 %1 nyano"),
    ...
    "newAccountIntro" : MessageLookupByLibrary.simpleMessage("這是您的新帳戶。當您收到 nyano 時，交易會顯示如下："),
    ...
    "notificationTitle" : MessageLookupByLibrary.simpleMessage("收到 %1 nyano"),
    ...
    "passwordNoLongerRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("您日後啟動 Nyano Mobile 時不用輸入密碼。"),
    "passwordWillBeRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("以後需要這個密碼方可開啟 Nyano Mobile。"),
    ...
    "requireAPasswordToOpenHeader" : MessageLookupByLibrary.simpleMessage("需要密碼才可開啟 Nyano Mobile 嗎？"),
    "rootWarning" : MessageLookupByLibrary.simpleMessage("您的裝置似乎已「越獄」或被修改，從而存在安全疑慮。建議您在繼續之前，將裝置還原至初始狀態。"),
    "scanInstructions" : MessageLookupByLibrary.simpleMessage("掃描 nyano 二維條碼地址"),
    ...
    "sendAmountConfirm" : MessageLookupByLibrary.simpleMessage("發送 %1 nyano？"),
    ...
    "shareNyano" : MessageLookupByLibrary.simpleMessage("分享 Nyano Mobile"),
    "shareNyanoText" : MessageLookupByLibrary.simpleMessage("請試試 Nyano Mobile —— 針對行動裝置的 nyano 錢包！"),
    ...
    "transferComplete" : MessageLookupByLibrary.simpleMessage("%1 nyano 順利移轉到您的 Nyano Mobile 錢包。\n"),
    "transferConfirmInfo" : MessageLookupByLibrary.simpleMessage("偵測到一個內有 %1 nyano 的錢包。\n"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("這過程會將紙錢包的資產移轉至您的 Nyano Mobile 錢包。\n\n輕觸 \"%1\" 按鈕開始。"),
    ...
    "transferNoFunds" : MessageLookupByLibrary.simpleMessage("這個種子不含任何 nyano"),
    "transferQrScanError" : MessageLookupByLibrary.simpleMessage("這個二維條碼不含任何有效的種子"),
    "transferQrScanHint" : MessageLookupByLibrary.simpleMessage("掃描 nyano 種子"),
    "unlock" : MessageLookupByLibrary.simpleMessage("解鎖"),
    "unlockBiometrics" : MessageLookupByLibrary.simpleMessage("經由生物辨識解鎖 Nyano Mobile"),
    "unlockPin" : MessageLookupByLibrary.simpleMessage("請輸入識別碼以解鎖 Nyano Mobile"),
    ...
    "welcomeText" : MessageLookupByLibrary.simpleMessage("歡迎來到 Nyano Mobile。接著您可建立新錢包或匯入現有錢包"),
