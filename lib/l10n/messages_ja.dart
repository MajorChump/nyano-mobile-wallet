...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "passwordNoLongerRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("Nyano Mobileを開く際にパスワードを必要としなくなります。"),
    "passwordWillBeRequiredToOpenParagraph" : MessageLookupByLibrary.simpleMessage("このパスワードはNyano Mobileを開く際に必要となります。"),
    ...
    "requireAPasswordToOpenHeader" : MessageLookupByLibrary.simpleMessage("Nyano Mobileを開く際にパスワードを要求しますか?"),
    ...
    "shareNyano" : MessageLookupByLibrary.simpleMessage("Nyano Mobileを共有する"),
    "shareNyanoText" : MessageLookupByLibrary.simpleMessage("優秀なナノモバイルウォレットであるナトリアムを使ってみましょう。"),
    ...
    "transferIntro" : MessageLookupByLibrary.simpleMessage("このプロセスにより、資金がペーパーウォレットからNyano Mobileウォレットに転送されます。\n \n「％1」ボタンをタップして開始します。"),
