...
import 'package:nyano_mobile_flutter/util/ninja/ninja_node.dart';
...
import 'package:nyano_mobile_flutter/network/model/request/fcm_update_request.dart';
...
import 'package:nyano_mobile_flutter/network/model/response/pending_response_item.dart';
...
class StateContainerState extends State<StateContainer> {
  ...
  // Minimum receive = 0.000001 nyano
  ...
  BaseTheme curTheme = NyanoMobileTheme();
  ...
  void handleSubscribeResponse(SubscribeResponse response) {
    ...
    if (response.pendingCount != null && response.pendingCount > 50) {
      // Bump min receive to 0.05 nyano
